        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          {selectedProvider && (
            <Card.Section className="flex items-center gap-3">
              <div
                className="size-10 rounded-lg flex items-center justify-center bg-bg border border-[var(--color-border)]"
              >
                <span
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 p-4 rounded-lg border transition-all ${
                    formData.authMethod === method.value
                      ? "border-[var(--color-text-main)] bg-[var(--color-text-main)]/5 text-[var(--color-text-main)]"
                      : "border-[var(--color-border)] hover:border-[var(--color-text-main)]/50"
                  }`}
                >
          ...
          {/* Error Message */}
          {errors.submit && (
            <div className="p-4 rounded-lg bg-[var(--color-danger)] dark:bg-[var(--color-danger)]/20 border border-[var(--color-danger)] dark:border-[var(--color-danger)] text-[var(--color-danger)] dark:text-[var(--color-danger)] text-sm">
              {errors.submit}
            </div>
          )}
