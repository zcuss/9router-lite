          ...
          {!checking && (
            <>
              <div className="flex items-start gap-3 p-3 bg-[var(--color-accent)]/10 border border-[var(--color-accent)]/30 rounded-lg">
                <span className="material-symbols-outlined text-[var(--color-accent)] text-lg">info</span>
                <div className="text-xs text-[var(--color-accent)] dark:text-[var(--color-accent)]">
                  <p className="font-medium">Writes to <code className="px-1 bg-[var(--color-surface-2)] dark:bg-[var(--color-surface)]/10 rounded">chatLanguageModels.json</code></p>
                    ...
                    <div className="flex flex-wrap gap-1.5 min-h-[28px] px-2 py-1.5 bg-[var(--color-surface)] rounded border border-[var(--color-border)]">
                      {selectedModels.length === 0 ? (
                        ...
                        selectedModels.map((model) => (
                          <span key={model} className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs bg-[var(--color-surface-2)] dark:bg-[var(--color-surface)]/5 text-[var(--color-text-muted)] border border-transparent hover:border-[var(--color-border)]">
                            {model}
                            <button onClick={(e) => { e.stopPropagation(); removeModel(model); }} className="ml-0.5 hover:text-[var(--color-danger)]">
