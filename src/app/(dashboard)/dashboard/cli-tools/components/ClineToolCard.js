              ...
              <div className="flex flex-col gap-3 p-4 bg-[var(--color-accent)]/10 border border-[var(--color-accent)]/30 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-[var(--color-accent)] dark:text-[var(--color-accent)]">Cline not detected locally</p>
              ...
              {showInstallGuide && (
                <div className="p-4 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg">
                  ...
                  <div className="space-y-3 text-sm">
                    <p className="text-[var(--color-text-muted)]">Install Cline VS Code extension or CLI from <a className="text-[var(--color-text-main)] underline" href="https://docs.cline.bot/" target="_blank" rel="noreferrer">docs.cline.bot</a>.</p>
                  </div>
                </div>
              )}
            </div>
