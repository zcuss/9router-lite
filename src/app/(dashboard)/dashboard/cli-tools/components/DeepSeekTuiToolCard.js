              ...
              <div className="flex flex-col gap-3 p-4 bg-[var(--color-accent)]/10 border border-[var(--color-accent)]/30 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-[var(--color-accent)] dark:text-[var(--color-accent)]">DeepSeek TUI not detected locally</p>
                    <p className="text-sm text-[var(--color-text-muted)] mt-1">Install via npm:</p>
                    <code className="block mt-2 p-2 bg-[var(--color-surface-2)]/20 rounded text-xs font-mono">npm install -g deepseek-tui</code>
                  ...
                  <div className="flex flex-col gap-2 mb-2">
                    {tool.notes.map((note, idx) => (
                      <div key={idx} className={`flex items-start gap-2 p-2 rounded text-xs ${
                        ...
                        note.type === "error" ? "bg-[var(--color-danger)]/10 text-[var(--color-danger)] dark:text-[var(--color-danger)]" :
                        "bg-[var(--color-accent)]/10 text-[var(--color-accent)] dark:text-[var(--color-accent)]"
                      }`}>
