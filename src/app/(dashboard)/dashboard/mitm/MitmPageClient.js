...
export default function MitmPageClient() {
  ...
  return (
    <div className="flex w-full flex-col gap-6">
      <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-[var(--color-accent)]/10 border border-[var(--color-accent)]/30">
        <span className="material-symbols-outlined text-[16px] text-[var(--color-accent)] mt-0.5 shrink-0">warning</span>
        <p className="text-xs text-[var(--color-danger)] dark:text-[var(--color-accent)] leading-relaxed">
