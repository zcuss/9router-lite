...
export default function DashboardHome() {
  ...
  const [endpoint, setEndpoint] = useState({ url: typeof window !== "undefined" ? `${window.location.origin}/v1` : "/v1" });
  ...
  return (
    <div className="px-4 sm:px-6 py-6 sm:py-8 pb-24 lg:pb-8 max-w-6xl mx-auto space-y-6">
      <header className="flex items-end justify-between flex-wrap gap-3">
        <div>
          <div className="text-[11px] uppercase tracking-wider text-[var(--color-text-subtle)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div className="rounded-lg border border-[var(--color-border-subtle)] p-5 bg-[var(--color-surface)]">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[10px] uppercase tracking-wider text-[var(--color-text-subtle)] font-medium">Endpoint</span>
        ...
        {showCreate && (
          <div className="px-5 py-4 border-b border-[var(--color-border-subtle)] bg-[var(--color-surface-2)] flex items-center gap-2">
            ...
            <button
              ...
              className="h-9 w-9 rounded-md border border-[var(--color-border-subtle)] text-[var(--color-text-muted)] hover:text-[var(--color-text-main)] flex items-center justify-center"
            >
              <X size={14} />
            </button>
          </div>
