...
export const APIKEY_PROVIDERS = {
  ...
  // === Free-tier LLM providers (synced from OmniRoute) — ENABLED in UI ===
  // Backend config (PROVIDERS, PROVIDER_MODELS, ALIAS_TO_PROVIDER_ID) remains active.
  agentrouter: { id: "agentrouter", alias: "agentrouter", name: "AgentRouter (OmniRoute Free)", icon: "router", color: "#10B981", textIcon: "AR", website: "https://agentrouter.org", notice: { text: "$200 free credits on signup - multi-model routing gateway.", apiKeyUrl: "https://agentrouter.org/register" }, passthroughModels: true, serviceKinds: ["llm"] },
  aimlapi: { id: "aimlapi", alias: "aiml", name: "AI/ML API (OmniRoute Free)", icon: "hub", color: "#6366F1", textIcon: "AI", website: "https://aimlapi.com", notice: { text: "$0.025/day free — 200+ models via single endpoint.", apiKeyUrl: "https://aimlapi.com/app/keys" }, passthroughModels: true, serviceKinds: ["llm", "image"] },
  novita: { id: "novita", alias: "novita", name: "Novita AI (OmniRoute Free)", icon: "auto_awesome", color: "#FF4081", textIcon: "NV", website: "https://novita.ai", notice: { text: "$0.50 trial credits on signup.", apiKeyUrl: "https://novita.ai/settings/key-management" }, passthroughModels: true, serviceKinds: ["llm", "image"] },
  modal: { id: "modal", alias: "mdl", name: "Modal (OmniRoute Free)", icon: "cloud_queue", color: "#7C3AED", textIcon: "MDL", website: "https://modal.com", notice: { text: "$30/month free credits for new accounts.", apiKeyUrl: "https://modal.com/settings/tokens" }, passthroughModels: true, serviceKinds: ["llm"] },
  nlpcloud: { id: "nlpcloud", alias: "nlpc", name: "NLP Cloud (OmniRoute Free)", icon: "psychology", color: "#2196F3", textIcon: "NLPC", website: "https://docs.nlpcloud.com", notice: { text: "Trial credits for new accounts.", apiKeyUrl: "https://nlpcloud.com/home/token" }, serviceKinds: ["llm"] },
