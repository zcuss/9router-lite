    ...
    <Modal isOpen={isOpen} title="Connect Kiro" onClose={onClose} size="lg">
      <div className="flex flex-col gap-4">
        ...
        {!selectedMethod && (
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full p-4 text-left border border-[var(--color-border)] rounded-lg hover:bg-sidebar transition-colors"
            >
              <div className="flex items-start gap-3">
                <span className="material-symbols-outlined text-[var(--color-text-main)] mt-0.5">shield</span>
            ...
            >
              <div className="flex items-start gap-3">
                <span className="material-symbols-outlined text-[var(--color-text-main)] mt-0.5">business</span>
                <div className="flex-1">
            ...
            <button
              ...
              className="hidden w-full p-4 text-left border border-[var(--color-border)] rounded-lg hover:bg-sidebar transition-colors"
            >
              <div className="flex items-start gap-3">
                <span className="material-symbols-outlined text-[var(--color-text-main)] mt-0.5">account_circle</span>
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <span className="material-symbols-outlined text-[var(--color-text-main)] mt-0.5">code</span>
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <span className="material-symbols-outlined text-[var(--color-text-main)] mt-0.5">file_upload</span>
                <div className="flex-1">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-2">
                IDC Start URL <span className="text-[var(--color-danger)]">*</span>
              </label>
              <Input
                value={idcStartUrl}
        ...
        {selectedMethod === "social-google" && (
          <div className="space-y-4">
            <div className="bg-[var(--color-accent)] dark:bg-[var(--color-accent)]/20 p-4 rounded-lg border border-[var(--color-accent)] dark:border-[var(--color-accent)]">
              <div className="flex gap-2">
                <span className="material-symbols-outlined text-[var(--color-accent)] dark:text-[var(--color-accent)]">info</span>
                <div className="flex-1 text-sm">
                  <p className="font-medium text-[var(--color-accent)] dark:text-[var(--color-accent)] mb-1">
                    Manual Callback Required
                  </p>
                  <p className="text-[var(--color-accent)] dark:text-[var(--color-accent)]">
          ...
          <div className="space-y-4">
            ...
            {!autoDetecting && (
              <>
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">
                    Refresh Token <span className="text-[var(--color-danger)]">*</span>
                  </label>
                  <Input
                    value={refreshToken}
